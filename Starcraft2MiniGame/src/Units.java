 ...
 * File: Units.java
 *
 * Class for controlling all unit
...
public class Units {
  ...
  private EZImage unit, aura, m_aura, unit2, unit3;                                        // Aura is general, m_aura is only mothership, unit2 - bc, unit3 - leviathan
  private EZImage sidepanel1, sidepanel2, sidepanel3, p_aura1, p_aura2, p_aura3, p_aura4;  // Pictures of side panel, 1 - battlecruiser, 2 - leviathan, 3 - mothership
  private EZImage explode, sidepanelaura1, sidepanelaura2, sidepanelaura3, projectile;     // Explode picture, 1 - battlecruiser, 2 - leviathan, 3 - mothership
  ...
  private boolean flag, auraflag, projflag = false;
  private static int MAPXLENGTH = 1500;
  private static int MAPYLENGTH = 1000;
  private static int HALFX = MAPXLENGTH / 2;
  private static int HALFY = MAPYLENGTH / 2;
  ...
  // Auras for units
  public Units(String sideaura, int distinguish_function) {
...
/* ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  // Check if projectile is touching in specified coordinates, true if is, false otherwise
  ...
  // Reset projectile if off screen
  private void resetProjectile() {
    if (xproj > MAPXLENGTH || xproj < 0 || yproj > MAPYLENGTH || yproj < 0) {
      projectile.hide();
      xproj = unit.getXCenter();
      yproj = unit.getYCenter();
  ...
  // Controls the mothership movement. Takes in (w,d,a,d) to move
  ...
  // Mothership contacts a building. Returns the building code #
...
/* ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  public void move() {
    ...
    // Mothership reaches destination
